...
public class ReportDao {
    ...
    /**
     * Report mensile per uno chef nel mese indicato (range semichiuso [primoGiorno, primoGiornoMeseSuccessivo) ).
     */
    public ReportMensile getReportMensile(String cfChef, YearMonth month) throws Exception {
        ...
        // NB: usa CAST PostgreSQL (::text) e un identificatore tra doppi apici ("idSessionePresenza")
        // Adatta i nomi delle colonne/tabelle al tuo schema.
        String sql = """
            WITH sess AS (
            ...
            SELECT
                ...
                -- Media: calcolata solo sulle pratiche; se nessuna pratica => NULL
                AVG( COALESCE(r.num_ricette, 0) ) FILTER (WHERE j.tipo = 'PRATICA') AS media_ricette,

                -- Max/Min: solo sulle pratiche; se nessuna pratica => NULL
        ...
        try (Connection conn = Db.get();
            ...
            // Se le colonne sono DATE va bene LocalDate; se sono TIMESTAMP usa LocalDateTime a mezzanotte.
            // Qui mappiamo a LocalDateTime per massima compatibilità.
